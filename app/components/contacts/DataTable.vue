...
const data = shallowRef<Contact[]>([
  ...
  {
    id: "JTK-30751",
    image: "/img/avatar-27.png",
    name: "Raj Patel",
    status: "Inactive",
    location: "Mumbai, IN",
    verified: false,
    referral: {
      image: "/img/avatar-28.png",
      name: "Yuki Tanaka",
    },
    value: 47,
    joinDate: "2023-12-15",
  ...
  {
    id: "XCU-85036",
    image: "/img/avatar-31.png",
    name: "Fatim Al-Sayed",
    status: "Active",
    location: "Cairo, EG",
    verified: false,
    referral: {
      image: "/img/avatar-32.png",
      name: "Anna Visconti",
    },
    value: 64,
    joinDate: "2023-09-10",
